# Cenário - Você trabalha para uma empresa automotiva e sua tarefa é agrupar veículos
#  com base em características como peso, tamanho do motor e potência.
...
# Save model
pickle.dump(kmeans, open('final_model.pkl', 'wb'))